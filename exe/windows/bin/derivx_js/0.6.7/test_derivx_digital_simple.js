...
function Gap_CalcPrice(module, s, k_1, k_2, r, q, v, t, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_gap_calc_price, 0, JSON.stringify(inputs)))
...
function Gap_CalcPayoff(module, s, k_1, k_2, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_gap_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function CashOrNothing_CalcPrice(module, s, k, r, q, v, t, cash, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_cash_or_nothing_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function CashOrNothing_CalcPayoff(module, s, k, cash, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_cash_or_nothing_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function AssetOrNothing_CalcPrice(module, s, k, r, q, v, t, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_asset_or_nothing_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function AssetOrNothing_CalcPayoff(module, s, k, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_asset_or_nothing_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function SuperShare_CalcPrice(module, s, k_l, k_h, r, q, v, t) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_super_share_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function SuperShare_CalcPayoff(module, s, k_l, k_h) {
    ...
    let result = JSON.parse(module.DirectCall(0, func_super_share_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function Test_Derivx_Digital_Simple() {
    ...
    let module = new cyberx.Create('derivx_digital_simple') // 全局唯一
    //let module_01 = new cyberx.Create('derivx_digital_simple') // 重复创建会报异常
    //let module_01 = new cyberx.GetCreate('derivx_digital_simple') // 可以获取已创建的实例
