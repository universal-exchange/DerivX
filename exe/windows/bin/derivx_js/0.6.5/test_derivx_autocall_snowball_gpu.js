...
class Config {
    constructor() {
        ...
        this.rand_quasi = false // 随机数据类型 // 目前 GPU 端 quasi 随机数据还不理想，暂勿使用
        ...
        this.knock_i_only_at_end = false // 是否仅在期末观察敲入 // GPU 版本此参数功能暂未实现
        this.knock_i_above_get = false // 是否在期末获得高于敲入价的绝对收益 // 针对锁盈缓冲结构，期末不观察敲出只观察敲入，需设置高敲出比率不发生敲出 // GPU 版本此参数功能暂未实现
...
async function Test_DerivX_Autocall_Snowball() {
    ...
    config.knock_i_only_at_end = false // 是否仅在期末观察敲入 // GPU 版本此参数功能暂未实现
