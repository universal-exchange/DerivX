...
class Config {
    constructor() {
        ...
        this.knock_o_occur = false // 是否已经敲出，仅针对敲出后到期支付资金，False 为尚未敲出，True 为已经敲出 // 累计期权很少用于融资，故未实际实现功能
        this.knock_o_point = 0.0 // 发生敲出时的价格点位记录，主要用于敲出增强 // 累计期权很少用于融资，故未实际实现功能
