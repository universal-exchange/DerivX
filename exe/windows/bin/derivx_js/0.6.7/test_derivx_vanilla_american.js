...
function Test_DerivX_Vanilla_American() {
    ...
    let module = new cyberx.Create('derivx_vanilla_american') // 全局唯一
    //let module_01 = new cyberx.Create('derivx_vanilla_american') // 重复创建会报异常
    //let module_01 = new cyberx.GetCreate('derivx_vanilla_american') // 可以获取已创建的实例
